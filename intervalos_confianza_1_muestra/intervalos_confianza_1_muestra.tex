...
\item En el cuadro de diálogo que aparece seleccionar la variable \variable{concentracion} y hacer click sobre el botón \boton{Aceptar}.
\end{enumerate}
}
\end{indicacion}
...
\item En el cuadro de diálogo que aparece seleccionar la variable \variable{concenctracion}.
\item En la solapa \menu{Estadísticos básicos} marcar el estadístico \campo{Cuasidesviación típica} y hacer click en el botón \boton{Aceptar}.
\item Seleccionar el menú \menu{Teaching\flecha Test paramétricos \flecha Cálculo del tamaño muestral para la media}.
\item En el cuadro de diálogo que aparece introducir la cuasidesviación típica muestral en el campo \campo{Desviación típica}, el nivel de significación deseado, en este caso $0.05$, en el campo \campo{Nivel de
significación}, el margen de error deseado, en este caso $0.5$, en el campo \campo{Error}, y hacer click en el botón \boton{Aceptar}.
\end{enumerate}
}
\end{indicacion}
...
\begin{enumerate}
\item Seleccionar el menú \menu{Teaching\flecha Test paramétricos\flecha Medias\flecha Test t para una muestra}.
\item En el cuadro de diálogo que aparece seleccionar la variable \variable{grasa} y hacer click sobre el botón \boton{Aceptar}.
\end{enumerate}
}
\end{indicacion}
...
\item En el cuadro de diálogo que aparece introducir el conjunto de datos al que aplicar el filtro, introducir la condición \comando{granja=='X'} en el campo \campo{Condición de selección},
introducir un nombre para el nuevo conjunto de datos en el campo \campo{Guardar nuevo conjunto de datos} y hacer click sobre el botón
\boton{Aceptar}.
\item Seleccionar el menú \menu{Teaching\flecha Test paramétricos\flecha Medias\flecha Test t para una muestra}.
\item En el cuadro de diálogo que aparece seleccionar la variable \variable{grasa} y hacer click sobre el botón \boton{Aceptar}.
\item Repetir los mismos pasos para el intervalo de confianza de la granja $Y$, introduciendo la condición \comando{granja=='Y'} en el
campo \campo{Condición de selección}.
\end{enumerate}
}
\end{indicacion}
...
\begin{indicacion}{
\begin{enumerate}
\item Seleccionar el menú \menu{Teaching\flecha Test paramétricos\flecha Proporciones\flecha Test de proporciones para una muestra}.
...
\item En la solapa \menu{Opciones de contraste} introducir $0.99$ en el campo \campo{Nivel de
confianza} y hacer click en el botón \boton{Aceptar}.
\end{enumerate}
}
\end{indicacion}
...
\begin{indicacion}{
\begin{enumerate}
\item Seleccionar el menú \menu{Teaching\flecha Test paramétricos\flecha Proporciones\flecha Cálculo del tamaño muestral para una proporción}.
\item En el cuadro de diálogo que aparece introducir la proporción muestral en el campo \campo{p}, el nivel de significación deseado, en este caso $0.05$, en el campo \campo{Nivel de significación}, el margen de error deseado, en este caso $0.01$, en el campo \campo{Error}, y
...
muestral} y hacer click en el botón \boton{Aceptar}.
\end{enumerate}}
\end{indicacion}
