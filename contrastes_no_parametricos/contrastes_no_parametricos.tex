...
%$HeadURL: https://practicas-r.googlecode.com/svn/trunk/contrastes_no_parametricos/contrastes_no_parametricos.tex $
%$LastChangedDate: 2011-12-05 14:06:12 +0100 (lun 05 de dic de 2011) $
%$LastChangedRevision: 19 $
%$LastChangedBy: asalber $
%$Id: contrastes_no_parametricos.tex 19 2011-12-05 13:06:12Z asalber $
...
% \begin{indicacion}{
% \begin{enumerate}
% \item Seleccionar el menú \menu{Distribuciones\flecha Distribuciones continuas\flecha Distribución normal\flecha Muestra de una
% distribución normal}.
...
% \begin{indicacion}{
% \begin{enumerate}
% \item Seleccionar el menú \menu{Gráficas\flecha Gráfica de comparación de cuantiles}.
...
% \begin{indicacion}{
% \begin{enumerate}
% \item Seleccionar el menú \menu{Estadísticos\flecha Test no paramétricos\flecha Test de normalidad de Shapiro-Wilk}.
...
% \begin{indicacion}{
% \begin{enumerate}
% \item Seleccionar el menú \menu{Distribuciones\flecha Distribuciones continuas\flecha Distribución uniforme\flecha Muestra de una
...
\begin{indicacion}{
\begin{enumerate}
\item Seleccionar el menú \menu{Teaching\flecha Test no paramétricos\flecha Normalidad\flecha Test de Shapiro-Wilk}.
...
% \begin{indicacion}{
% \begin{enumerate}
% \item Seleccionar el menú \menu{Estadísticos\flecha Varianzas\flecha Test de Levene}
...
\begin{enumerate}
\item Seleccionar el menú \menu{Teaching\flecha Test no paramétricos\flecha Test U de Mann-Whitney para dos muestras independientes}.
...
\begin{enumerate}
\item Seleccionar el menú \menu{Teaching\flecha Test no paramétricos\flecha Test de Wilcoxon para dos muestras pareadas}.
...
\begin{indicacion}{
\begin{enumerate}
\item Seleccionar el menú \menu{Teaching\flecha Gráficos\flecha Diagrama de cajas}.
...
\begin{indicacion}{
\begin{enumerate}
\item Seleccionar el menú \menu{Teaching\flecha Test paramétricos\flecha Varianzas\flecha Test de Levene}.
...
\begin{enumerate}
\item  Seleccionar el menú \menu{Teaching\flecha Estadísticos\flecha Test no paramétricos\flecha Test de Kruskal-Wallis}.
\item En el cuadro de diálogo que aparece, seleccionar la variable \variable{variacion.presion} en el campo \campo{Comparar}, la
variable \variable{farmaco} en el campo \campo{Según} y hacer click en el botón \boton{Aceptar}.
\end{enumerate}
}
...
\begin{enumerate}
\item Seleccionar el menú \menu{Teaching\flecha Test no paramétricos\flecha Test de Friedman para medidas repetidas}.
