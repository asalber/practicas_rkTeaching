...
\begin{indicacion}
\begin{enumerate}
\item Seleccionar el menú \menu{Teaching > Distribuciones > Continuas > Uniforme > Probabili\-dades}.
...
\begin{indicacion}
\begin{enumerate}
\item Seleccionar el menú \menu{Teaching > Distribuciones > Continuas > Normal > Probabili\-dades}.
...
\begin{indicacion}
\begin{enumerate}
\item Seleccionar el menú \menu{Teaching > Distribuciones > Continuas > Chi-cuadrado > Probabili\-dades}.
...
\begin{indicacion}
\begin{enumerate}
\item Seleccionar el menú \menu{Teaching > Distribuciones > Continuas > F de Fisher > Probabili\-dades}.
