...
En RKWard, también puede instalarse desde la ventana de R mediante el menú \menu{Preferencias\flecha Configurar
paquetes}.
Con esto aparecerá una ventana donde se muestran los paquetes instalados localmente.
Para cargar un paquete instalado localmente basta son seleccionarlo y hacer click sobre el botón \boton{Cargar}.
...
Para instalar un paquete nuevo basta con seleccionarlo y hacer click en el botón \boton{Aceptar}.
...
correspondiente del menú \menu{Inicio\flecha Programas\flecha RKWard}, o bien sobre el icono de escritorio
\begin{center}
...
Para ello hay que ir al menu \menu{Archivo\flecha Nuevo \flecha Conjunto de datos}. Con esto
...
Los objetos definidos en el espacio de trabajo pueden verse haciendo click en la solapa \menu{Espacio de trabajo}.
...
Para ello se utiliza el menú \menu{Teaching\flecha Datos\flecha Ponerar datos}.
...
trabajo\flecha Guardar espacio de trabajo}.
...
También es posible guardar los datos en un fichero de texto plano mediante el menú \menu{Archivo\flecha Exportar\flecha
Export tabular data}.
...
fichero. Para ello se utiliza el \menu{Espacio de trabajo\flecha Abrir espacio de trabajo} y en la ventana que aparece
...
Para ello se utiliza el menú \menu{Archivo\flecha Importar\flecha Importar datos} y en la ventana que aparece se
...
click con el botón derecho del ratón sobre él y seleccionando el menú \menu{Eliminar}.
...
Para ello se utiliza el menú \menu{Teaching\flecha Datos\flecha Filtrar}.
...
\menu{Teaching\flecha Datos\flecha Calcular variable}.
...
Para recodificar una variable se utiliza el menú \menu{Teaching\flecha Datos\flecha Recodificar variable}.
...
Para guardar el contenido de la ventana de resultados en un fichero se utiliza el menú \menu{Archivo\flecha Exportar
página como HTML}.
...
Para ello hay que seleccionar el menú \menu{Edición\flecha Limpiar salida}.
...
Para crear un guión de comandos hay que seleccionar el menú \menu{Archivo\flecha Nuevo\flecha Archivo de guiones}.
...
\menu{Archivo\flecha Guardar guión} e indicando el nombre del fichero y la carpeta donde se guardará en el
cuadro de diálo que aparece.


\subsection{Abrir un guión de comandos}
Para abrir un fichero con un guión de comandos se utiliza el menú \menu{Archivo\flecha Abrir archivo de guiones de R} y
...
Finalmente, también es posible invocar la ayuda general de R en RKWard con el menú \menu{Ayuda\flecha Ayuda de R} con lo
que aparecerá una página web desde donde podremos navegar a la información deseada. También es posible buscar ayuda
sobre un comando concreto en el menú \menu{Ayuda\flecha Buscar en la ayuda de R}.
...
\begin{enumerate}
\item Seleccionar el menú \menu{Archivo\flecha Nuevo\flecha Conjunto de datos}.
\item En el cuadro de diálogo que aparece introducir el nombre del conjunto de datos \variable{colesterol} y hacer click en el botón \boton{Aceptar}.
...
\begin{enumerate}
\item Selecionar el menú \menu{Espacio de trabajo\flecha Guardar espacio de trabajo}.
...
\begin{enumerate}
\item Seleccionar el menú \menu{Espacio de trabajo\flecha Abrir espacio de trabajo}.
...
\begin{enumerate}
\item Hacer click en la solapa \boton{Espacio de trabajo}.
\item En la ventana del espacio de trabajo doble click sobre el conjunto de datos \variable{colesterol}.
...
\begin{indicacion}{
\begin{enumerate}
\item Seleccionar el menú \menu{Teaching\flecha Datos\flecha Calcular variable}.
...
\item En el cuadro de diálogo que aparece seleccionar como objeto padre la el conjunto de datos \variable{colesterol} y hacer click sobre el botón \boton{Aceptar}.
\item Introducir el nombre de la nueva variable \variable{imc} y hacer click sobre el botón \boton{Aceptar}.
\end{enumerate} 
}
\end{indicacion}
...
\item En el cuadro \campo{Guardar nueva variable} hacer click sobre el botón \boton{Cambiar}.
\item En el cuadro de diálogo que aparece seleccionar como objeto padre la el conjunto de datos \variable{colesterol} y hacer click sobre el botón \boton{Aceptar}.
\item Introducir el nombre de la nueva variable \variable{obesidad} y hacer click sobre el botón \boton{Aceptar}.
\end{enumerate}
}
\end{indicacion}
...
\begin{indicacion}{
\begin{enumerate}
\item Selecionar el menú \menu{Teaching\flecha Datos\flecha Filtrar}.
...
\item Introducir el nombre del  nuevo conjunto de datos \variable{colesterol.hombres} y hacer click sobre el botón \boton{Aceptar}.
\end{enumerate}
}
\end{indicacion}
