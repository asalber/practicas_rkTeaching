...
\item En el cuadro de diálogo que aparece, seleccionar como \campo{Y} la variable \variable{Y} y como
\campo{Variable X} la variable \variable{X}, y hacer click en el botón \boton{Aceptar}.
\end{enumerate}}
\end{indicacion}
...
\begin{indicacion}{
\begin{enumerate}
\item Seleccionar el menú \menu{Teaching\flecha Regresión\flecha Regresión lineal}.
\item En el cuadro de diálogo que aparece, seleccionar la variable \variable{Y} como \campo{Variable dependiente} y la
variable \variable{X} como \campo{Variable independiente}, seleccionar \opcion{Guardar el modelo}, introducir un nombre
para el modelo y hacer click sobre el botón \boton{Aceptar}.
\end{enumerate}}
\end{indicacion}
...
\item Seleccionar el menú \menu{Teaching\flecha Gráficos\flecha Diagrama de Dispersión}.
\item En el cuadro de diálogo que aparece, seleccionar como \campo{Y} la variable \variable{Y} y como
\campo{Variable X} la variable \variable{X}.
\item En la solapa \menu{Línea de ajuste}, seleccionar \opcion{Dibujar recta de regresión} y hacer click en el botón \boton{Aceptar}.
\end{enumerate}}
\end{indicacion}
...
Se pide:
\begin{enumerate}
\item  Crear un conjunto de datos con las variables \variable{horas\_estudio} y \variable{suspensos} e introducir estos
datos.

\item  Calcular la recta de regresión de \variable{suspensos} sobre \variable{horas\_estudio} y dibujarla.
\begin{indicacion}{
Para calcular la recta de regresión:
\begin{enumerate}
\item Seleccionar el menú \menu{Teaching\flecha Regresión\flecha Regresión lineal}.
\item En el cuadro de diálogo que aparece, seleccionar la variable \variable{suspensos} como \campo{Variable
dependiente} y la variable \variable{horas\_estudio} como \campo{Variable independiente}, seleccionar \opcion{Guardar el
modelo}, introducir un nombre para el modelo y hacer click sobre el botón \boton{Aceptar}.
\end{enumerate}
Para dibujar la recta de regresión:
\begin{enumerate}
\item Seleccionar el menú \menu{Teaching\flecha Gráficos\flecha Diagrama de Dispersión}.
\item En el cuadro de diálogo que aparece, seleccionar como \campo{Y} la variable \variable{suspensos} y como
\campo{Variable X} la variable \variable{horas\_estudio}.
\item En la solapa \menu{Línea de ajuste}, seleccionar \opcion{Dibujar recta de regresión} y hacer click en el botón
\boton{Aceptar}.
\end{enumerate}}
\end{indicacion}
...
apartado, introducir los valores para los que se desea la predicción en el campo \campo{Predicciones para} y hacer click
...
todo?
\begin{indicacion}{
Seguir los mismos pasos de los apartados anteriores, pero escogiendo como variable dependiente \variable{horas\_estudio},
...
\begin{enumerate}
\item Seleccionar el menú \menu{Teaching\flecha Regresión\flecha Regresión lineal}.
\item En el cuadro de diálogo que aparece, seleccionar la variable \variable{alcohol} como \campo{Variable dependiente}
y la variable \variable{tiempo} como \campo{Variable independiente}, y hacer click sobre el botón \boton{Aceptar}.
\end{enumerate}}
\end{indicacion}
...
\begin{enumerate}
\item Seleccionar el menú \menu{Teaching\flecha Gráficos\flecha Diagrama de Dispersión}.
\item En el cuadro de diálogo que aparece, seleccionar como \campo{Y} la variable \variable{alcohol} y como
\campo{Variable X} la variable \variable{tiempo}.
\item En la solapa \menu{Línea de ajuste}, seleccionar \opcion{Dibujar recta de regresión} y hacer click en el botón
\boton{Aceptar}.
\end{enumerate}
...
\begin{enumerate}
\item Seleccionar el menú \menu{Teaching\flecha Regresión\flecha Regresión lineal}.
\item En el cuadro de diálogo que aparece, seleccionar la variable \variable{tiempo} como \campo{Variable dependiente} y la
variable \variable{alcohol} como \campo{Variable independiente}.
\item Seleccionar \opcion{Guardar el modelo}, introducir un nombre para el modelo y hacer click sobre el botón \boton{Aceptar}.
\end{enumerate}
Para hacer la predicción:
\begin{enumerate}
\item Seleccionar el menú \menu{Teaching\flecha Regresión\flecha Predicciones}.
\item En el cuadro de diálogo que aparece seleccionar como modelo de regresión la recta calculada e introducir los
valores para los que se desea la predicción en el campo \campo{Predicciones para} y hacer click sobre el botón
\boton{Aceptar}.
\end{enumerate}}
\end{indicacion}
\end{enumerate}
...
\begin{enumerate}
\item Seleccionar el menú \menu{Teaching\flecha Regresión\flecha Regresión lineal}.
\item En el cuadro de diálogo que aparece, seleccionar la variable \variable{estatura} como \campo{Variable dependiente}
y la variable \variable{edad} como \campo{Variable independiente}, 
\item Seleccionar \opcion{Guardar el modelo}, introducir un nombre para el modelo y hacer click sobre el botón \boton{Aceptar}.
\boton{Aceptar}.
\end{enumerate}}
\end{indicacion}
...
\begin{enumerate}
\item Seleccionar el menú \menu{Teaching\flecha Gráficos\flecha Diagrama de Dispersión}.
\item En el cuadro de diálogo que aparece, seleccionar como \campo{Y} la variable \variable{estatura} y como
\campo{Variable X} la variable \variable{edad}, y hacer click en el botón \boton{Aceptar}.
\end{enumerate}}
\end{indicacion}
...
\begin{indicacion}{
\begin{enumerate}
\item Seleccionar el menú \menu{Teaching\flecha  Datos\flecha Recodificar variable}.
...
\item En el cuadro de diálogo que aparece seleccionar como objeto padre la el conjunto de datos \variable{edad\_estatura} y hacer click sobre el botón \boton{Aceptar}.
\item Introducir el nombre de la nueva variable \variable{grupo\_edad} y hacer click sobre el botón \boton{Aceptar}.
\end{enumerate}}
\end{indicacion}
...
\item En el cuadro de diálogo que aparece, seleccionar la variable \variable{estatura} como \campo{Variable dependiente}
y la variable \variable{edad} como \campo{Variable independiente}.
\item Seleccionar la opición \opcion{Filtro} e introducir en el campo \campo{Condición de selección} la condición
\lstinline{grupo_edad="menores"}.
\item Seleccionar \opcion{Guardar el modelo}, introducir un nombre para el modelo y hacer click sobre el botón
\boton{Aceptar}.
\end{enumerate}
...
\item Seleccionar el menú \menu{Teaching\flecha Gráficos\flecha Diagrama de Dispersión}.
\item En el cuadro de diálogo que aparece, seleccionar como \campo{Y} la variable \variable{estatura} y como
\campo{Variable X} la variable \variable{edad}.
\item Seleccionar la opción \opcion{Diferenciar grupos} e introducir la variable \variable{grupo\_edad} en el campo
...
introducir 14 en el campo \campo{Predicciones para} y hacer click sobre el botón
\boton{Aceptar}.
\end{enumerate}
...
\begin{indicacion}{
\begin{enumerate}
\item Seleccionar el menú \menu{Teaching\flecha Regresión\flecha Correlación}.
\item En el cuadro de diálogo que aparece seleccionar todas las variables numéricas y hacer click sobre el botón \boton{Aceptar}. 
\end{enumerate}}
\end{indicacion}
...
\begin{enumerate}
\item Seleccionar el menú \menu{Teaching\flecha Datos\flecha Filtrar datos}.
\item En el cuadro de diálogo que aparece seleccionar el conjunto de datos \variable{naciones}.
\item Introducir la condición \lstinline{region=="Europe"} en el campo \campo{Condición de selección}.
\item Introducir el nombre \variable{europa} en el campo \campo{Guardar nuevo conjunto de
datos} y hacer click en el botón \boton{Aceptar}.
\item Seleccionar el menú \menu{Teaching\flecha Regresión\flecha Correlación}.
\item En el cuadro de diálogo que aparece seleccionar las variables \variable{fertilidad} y
\variable{mortalidad.infantil} del conjunto de datos \variable{europa} y hacer click sobre el botón \boton{Aceptar}.
\end{enumerate}
...
\begin{enumerate}
\item Seleccionar el menú \menu{Teaching\flecha Regresión\flecha Correlación}.
\item En el cuadro de diálogo que aparece seleccionar la variables \variable{X} e \variable{Y}.
\item En la solapa \menu{Opciones de correlación} seleccionar el método de \opcion{Ro de Spearman} y hacer click sobre
