...
Se pide
\begin{enumerate}
\item Crear un conjunto de datos con las varaibles \variable{tens.habitual} y \variable{tens\button{}.
...
intraclase}.
\item Seleccionar las variables \variable{tens.habitual} en el campo \field{Primera medida}, la
variable\variable{tens.muñeca} en el campo \field{Segunda medida} y hacer click en el botón \boton{Aceptar}.
\end{enumerate}
...
% \item En el cuadro de diálogo que aparece seleccionar la variable \variable{tens\_muñeca} como \field{variable x} y la
% variable \variable{tens\_habitual} como \field{variable y}, activar únicamente la opción \option{Línea de mínimos
...
% misma medida.
% \begin{indicacion}
% Sin cerrar la ventana gráfica del apartado anterior, ejecutar el comando \command{abline(0,1)} para dibujar la recta
...
dichos informes hubo 32 radiografías en que ambos radiólogos apreciaron metástasis, 68 radio\button{ en que ninguno las
...
\item Seleccionar las variables \variable{radiologoA} en el campo \field{Primera medida}, la
variable \variable{radiologoB} en el campo \field{Segunda medida} y hacer click en el botón \boton{Aceptar}.
\end{enumerate}
