...
\field{Variables}.
\item En la solapa \menu{Estadísticos básicos} activar la casilla de selección para la \option{Media} y la
\option{Desviación típica} y hacer clic en el botón \button{Enviar}.
\end{enumerate}
}
\end{indicacion}
...
\item En el cuadro de diálogo que aparece seleccionar la variable \variable{antes} en el campo \field{Comparar}, la variable
\variable{después} en el campo \field{Con}.
\item En la solapa \menu{Opciones de contraste} introducir $0.95$ en el campo \field{Nivel de confianza} y hacer clic en el botón
\button{Enviar}.
\item Repetir los pasos para el intervalo de confianza con nivel de significación $0.01$ poniendo $0.99$ en el campo \field{Nivel de
confianza}.
\end{enumerate}
}
\end{indicacion}
...
\item En el cuadro de dialogo que aparece seleccionar la variable \variable{grasa} en el campo \field{Comparar} y
seleccionar la variable \variable{granja} en el campo \field{Según}.
\item En la solapa \menu{Opciones de contraste} introducir $0.95$ en el campo \field{Nivel de confianza} y hacer clic sobre el botón \button{Enviar}.
\end{enumerate}
...
\item En el cuadro de dialogo que aparece seleccionar la variable \variable{grasa} en el campo \field{Comparar} y
seleccionar la variable \variable{granja} en el campo \field{Según}.
\item En la solapa \menu{Opciones de contraste} introducir $0.95$ en el campo \field{Nivel de confianza}, marcar la opción \option{Si} en el campo \field{Suponer varianzas iguales} y hacer clic sobre el botón \button{Enviar}.
\end{enumerate}
}
\end{indicacion}
...
\item En el cuadro de dialogo que aparece seleccionar la variable \variable{respuesta} en el campo \field{Comparar},
seleccionar la variable \variable{sexo} en el campo \field{Según}, introducir el valor \texttt{si} al campo
\field{Categoría} y hacer clic sobre el botón \button{Enviar}.
\end{enumerate}
...
\begin{enumerate}
\item Seleccionar el menú \menu{Teaching>Test paramétricos>Proporciones>Test para la comparación de dos proporciones}.
\item En el cuadro de diálogo que aparece seleccionar la opción \option{Introducción manual de frecuencias}, introducir 55 en el campo \field{Frecuencia muestral 1}, introducir 80 en el campo
\field{Tamaño muestral 1}, introducir 32 en el campo \field{Frecuencia muestral 2}, introducir 90 en el campo
\field{Tamaño muestral 2} y hacer clic en el botón \button{Enviar}.
\end{enumerate}}
\end{indicacion}
