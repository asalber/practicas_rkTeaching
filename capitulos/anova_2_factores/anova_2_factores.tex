...
\begin{indicacion}
\begin{enumerate}
\button{eleccionar el menú \menu{Teaching > Gráficos > Diagrama de interacción}.
\item Seleccionar la variable \variable{kilos\_perdidos} en el campo \field{Variable respuesta}, la variable
\variable{dieta} en el campo \field{Grupos eje X} y la variable \variable{farmaco} en el campo \field{Grupos de
...
\item Seleccionar la variable \variable{kilos\_perdidos} como \field{Variable dependiente} y las variables
\variable{dieta} y \variable{farmaco} en el campo \field{Factores entre individuos}, y hacer click sobre el botón
\boton{Aceptar}.
\end{enumerate}

Para la interpretación de la tabla de ANOVA, prestar especial atención a las siguientes líneas de la tabla:
\begin{enumerate}
\item \result{dieta}: muestra si la dieta resulta o no significativa para explicar la variabilidad del peso perdido.
\item \result{farmaco}: muestra si el fármaco resulta o no significativo.
\item \result{dieta:farmaco}: muestra si la interacción de dieta y fármaco resulta o no significativa.
\end{enumerate}
Una conclusión muy im\button{e a la luz de los resultados es que no hay una interacción significativa entre dieta y
...
\item Seleccionar el menú \texttt{Teaching > Tests paramétricos > Medias > ANOVA}.
\item En el cuadro de diálogo que aparece, seleccionar el conjunto de datos \variable{dieta.farmaco}.
\item Seleccionar la variable \variable{kilos\_perdidos} como \field{Variable
dependiente} y las variables \variable{dieta} y \variable{farmaco} en el campo \field{Factores entre individuos}.
\item En la solapa \menu{Comparación por pares} seleccionar la opción \option{Comparación de medias por pares} y hacer
...
\button{nclusiones cualitativas pueden sacarse del gráfico obtenido? 
\begin{indicacion}
\begin{enumerate}
...
métodos diferentes de aprendizaje de\button{eria del cuestionario. Los resultados aparecen en la siguiente tabla:
...
\begin{enumerate}
\item Seleccionar el menú \menu{Teaching > Gráficos > Diagrama de interacción}.
\item Seleccionar la variable \variable{dias} en el campo \field{Variable respuesta}, la variable
\variable{metodo} en el campo \field{Grupos eje X} y la variable \variable{sexo} en el campo \field{Grupos de
trazado}, y hacer click en el botón \boton{Aceptar}.
\end{enumerate}
...
\item Seleccionar la variable \variable{dias} como \field{Variable dependiente} y las variables
\variable{sexo} y \variable{metodo} en el campo \field{Factores entre individuos}, y hacer click sobre el botón
\boton{Aceptar}.
\end{enumerate}
...
\item En el cuadro de diálogo que aparece, seleccionar el conjunto de datos \variable{metodo.aprendizaje}.
\item Seleccionar la variable \variable{dias} como \field{Variable dependiente} y las variables
\variable{sexo} y \variable{metodo} en el campo \field{Factores entre individuos}.
\item En la solapa \menu{Comparación por pares} seleccionar la opción \option{Comparación de medias por pares} y hacer
click sobre el botón \boton{Aceptar}.
\end{enumerate}
\end{indicacion}
...
\item Seleccionar la opción de diseño \option{Dentro de individuos (medidas repetidas)}.
\item Seleccionar la variable \variable{tiempo} como \field{Variable dependiente}, la variable \variable{repigmentador}
en el campo \field{Factores dentro de los individuos}, la variable \variable{individuo} en el campo \field{Identificador
...
\item Seleccionar la opción de diseño \option{Dentro de individuos (medidas repetidas)}.
\item Seleccionar la variable \variable{tiempo} como \field{Variable dependiente}, la variable \variable{repigmentador}
en el campo \field{Factores dentro de los sujetos}, la variable \variable{individuo} en el campo \field{Identificador de
los individuos}.
\item En la solapa \menu{Comparación por pares} seleccionar la opción \option{Comparación de medias por pares} y hacer
click sobre el botón \boton{Aceptar}.
\end{enumerate}
...
\item Mostrar el gráfico de interacció\button{s del redimiento para los distintos grupos según el tipo de entrenamiento y
la semana.
¿Qué se puede decir de la interacción de las variables?
\begin{indicacion}
\begin{enumerate}
\item Seleccionar el menú \menu{Teaching > Gráficos > Diagrama de interacción}.
\item Seleccionar la variable \variable{rendimiento} en el campo \field{Variable respuesta}, la variable
\variable{semana} en el campo \field{Grupos eje X} y la variable \variable{entrenamiento} en el campo \field{Grupos de
trazado}, y hacer click en el botón \boton{Aceptar}.
\end{enumerate}
Es evidente que las líneas se cruzan, lo cual indica que hay interacción.
\end{indicacion}
...
\item Seleccionar la opción de diseño \option{Mixto}.
\item Seleccionar la variable \variable{rendimiento} como \field{Variable dependiente}, la variable
\variable{entrenamiento} en el campo \field{Factores entre individuos}, la variable \variable{semana} en el campo
\field{Factores dentro de los individuos}, la variable \variable{individuo} en el campo \field{Identificador de los
