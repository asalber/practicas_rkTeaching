...
\chapter{Probabilidad}\label{cap:probabilidad}
...
\item En el cuadro de diálogo que aparece y hacer clic en el botón \button{Enviar}. 
\end{enumerate}
\end{indicacion}
...
\item En el cuadro de diálogo que aparece, introducir 2 en el campo \field{Número de monedas} y hacer clic en el botón \button{Enviar}.
\end{enumerate}
\end{indicacion}
...
\item En el cuadro de diálogo que aparece, introducir 2 en el campo \field{Número de dados} y hacer clic en el botón \button{Enviar}.
\end{enumerate}
\end{indicacion}
...
dos monedas y del lanzamiento de dos dados generados en los apartados anteriores, y hacer clic en el botón \button{Enviar}.
\end{enumerate}
\end{indicacion}
\end{enumerate}  
...
\item En el cuadro de diálogo que aparece, introducir 2 en el campo \field{Número de monedas}, introducir 10 en el campo \field{Número de
lanzamientos}, activar la casilla \option{Distribución de frecuencias} y hacer clic en el botón \button{Enviar}.
\end{enumerate}
Repetir los mismos pasos pero introduciendo 100, 1000 y 1000000 respectivamente en el campo \option{Número de lanzamientos}.
...
\item En el cuadro de diálogo que aparece, seleccionar la opción \option{Lista de objetos}, introducir los objetos A,A,A,B,B,C en
el campo \field{Lista de objetos}, introducir 3 en el campo \field{Número de extracciones}, y hacer clic en el botón \button{Enviar}.
\end{enumerate}
\end{indicacion}

\item Elegir tres medicamentos al azar con reemplazamiento.
\begin{indicacion}
Repetir los mismos pasos del apartado anterior pero además activando la casilla \option{Con reemplazamiento}.
\end{indicacion}
\end{enumerate}
...
% \variable{mendel.color.ep} al espacio probabilístico y hacer clic en el botón \button{Enviar}.
...
% \field{Número de repeticiones}, darle el mismo nombre al espacio probabilístico resultante y hacer clic en el botón \button{Enviar}. 
% \end{enumerate}
...
% \command{alelo.color.progenitor.1 == "\mbox{A}"\ | alelo.color.pro\-genitor.2 == "\mbox{A}"} en el campo \field{Suceso} y hacer clic en el
% botón \button{Enviar}.
% \end{enumerate}
...
% \variable{mendel.forma.ep} al espacio probabilístico y hacer clic en el botón \button{Enviar}.
...
% probabilístico resultante y hacer clic en el botón \button{Enviar}. 
...
% alelo.for\-ma.\-pro\-genitor.2 == "B")} en el campo \field{Suceso}, y hacer clic en el botón \button{Enviar}.
% \end{enumerate}
...
% alelo.forma.\-progenitor.2 == "\mbox{b}"} en el campo \field{Suceso} y hacer clic en el botón \button{Enviar}.
% \end{enumerate}
% \end{indicacion}
% \end{enumerate}
...
\option{Definir frecuencias}, seleccionar la variable \variable{frecuencia} en el campo \field{Frecuencia}, darle el nombre
\variable{enfermedades.infantiles.ep} al espacio probabilístico y hacer clic en el botón \button{Enviar}.
\end{enumerate}
\end{indicacion}  
...
\command{varicela == "Si"} en el campo \field{Suceso} y hacer clic en el botón \button{Enviar}.
\end{enumerate}
\end{indicacion} 
...
\item Seleccionar el menú \menu{Teaching > Probabilidad > Calcular probabilidad}.
\item En el cuadro de diálogo que aparece seleccionar el espacio probabilístico \variable{enfermedades.infantiles.ep}, introducir
\command{varicela == "Si"\ | sarampion=="Si"} en el campo \field{Suceso} y hacer clic en el botón \button{Enviar}.
\end{enumerate}
\end{indicacion} 
...
\item Seleccionar el menú \menu{Teaching > Probabilidad > Calcular probabilidad}.
\item En el cuadro de diálogo que aparece seleccionar el espacio probabilístico \variable{enfermedades.infantiles.ep}, introducir
\command{sarampion == "Si"\ \& rubeola=="Si"} en el campo \field{Suceso} y hacer clic en el botón \button{Enviar}.
\end{enumerate}
\end{indicacion} 
...
\item Seleccionar el menú \menu{Teaching > Probabilidad > Calcular probabilidad}.
\item En el cuadro de diálogo que aparece seleccionar el espacio probabilístico \variable{enfermedades.infantiles.ep}, introducir
\command{varicela == "Si"} en el campo \field{Suceso}, activar la casilla \option{Probabilidad condicionada}, introducir \command{sarampion
== "No"} en el campo \field{Condición} y hacer clic en el botón \button{Enviar}.
\end{enumerate}
\end{indicacion} 
...
\item Seleccionar el menú \menu{Teaching > Probabilidad > Calcular probabilidad}.
\item En el cuadro de diálogo que aparece seleccionar el espacio probabilístico \variable{enfermedades.infantiles.ep}, introducir
\command{rubeola == "No"\ \& sarampion=="No"} en el campo \field{Suceso}, activar la casilla \option{Probabilidad condicionada}, introducir
\command{varicela == "Si"} en el campo \field{Condición} y hacer clic en el botón \button{Enviar}.
\end{enumerate}
\end{indicacion} 
\end{enumerate}
...
\option{Definir frecuencias}, seleccionar la variable \variable{frecuencia} en el campo \field{Frecuencia}, darle el nombre
\variable{test.embarazo.ep} al espacio probabilístico y hacer clic en el botón \button{Enviar}.
\end{enumerate}
\end{indicacion}  
...
\command{embarazo == "Si"} en el campo \field{Suceso} y hacer clic en el botón \button{Enviar}.
\end{enumerate}
\end{indicacion} 
...
\item Seleccionar el menú \menu{Teaching > Probabilidad > Calcular probabilidad}.
\item En el cuadro de diálogo que aparece seleccionar el espacio probabilístico \variable{test.embarazo.ep}, introducir
\command{test == "\mbox{+}"} en el campo \field{Suceso} y hacer clic en el botón \button{Enviar}.
\end{enumerate}
\end{indicacion} 
...
\item Seleccionar el menú \menu{Teaching > Probabilidad > Calcular probabilidad}.
\item En el cuadro de diálogo que aparece seleccionar el espacio probabilístico \variable{test.embarazo.ep}, introducir
\command{test=="\mbox{+}"} en el campo \field{Suceso}, activar la casilla \option{Probabilidad condicionada}, introducir
\command{embarazo == "Si"} en el campo \field{Condición} y hacer clic en el botón \button{Enviar}.
\end{enumerate}
\end{indicacion} 
...
\item En el cuadro de diálogo que aparece seleccionar el espacio probabilístico \variable{test.embarazo.ep}, introducir
\command{test=="\mbox{-}"} en el campo \field{Suceso}, activar la casilla \option{Probabilidad condicionada}, introducir
\command{embarazo == "No"} en el campo \field{Condición} y hacer clic en el botón \button{Enviar}.
\end{enumerate}
\end{indicacion} 
...
\item Seleccionar el menú \menu{Teaching > Probabilidad > Calcular probabilidad}.
\item En el cuadro de diálogo que aparece seleccionar el espacio probabilístico \variable{test.embarazo.ep}, introducir
\command{embarazo=="Si"} en el campo \field{Suceso}, activar la casilla \option{Probabilidad condicionada}, introducir
\command{test=="\mbox{+}"} en el campo \field{Condición} y hacer clic en el botón \button{Enviar}.
\end{enumerate}
\end{indicacion} 
...
\item Seleccionar el menú \menu{Teaching > Probabilidad > Calcular probabilidad}.
\item En el cuadro de diálogo que aparece seleccionar el espacio probabilístico \variable{test.embarazo.ep}, introducir
\command{embarazo=="No"} en el campo \field{Suceso}, activar la casilla \option{Probabilidad condicionada}, introducir
\command{test=="\mbox{-}"} en el campo \field{Condición} y hacer clic en el botón \button{Enviar}.
\end{enumerate}
\end{indicacion} 
\end{enumerate} 
