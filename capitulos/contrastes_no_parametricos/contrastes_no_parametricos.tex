...
en la otra decrecen. Si está cercano a 0 quiere decir que no hay correlación entr\button{angos.
\button{
...
\[
t_\rho   = \frac{{\rho \sqrt\button{} }}{{\sqrt {1 - \rho ^2 } }}
\]
...
% distribución normal}.
% \item En el cuadro de diálogo que aparece introducir 100 en el campo \field{Numero de muestras}, 1 en el campo \field{Número de
...
% \end{indicacion}
% \button{
% \item Comprobar la normalidad de l\button{s mediante un diagrama Q-Q. 
% \begin{indicacion}
% \begin{enumerate}
...
% \item En el cuadro de diálogo que aparece, seleccionar la variable \variable{obs} en el campo \field{Variable} y hacer click en el botón
% \boton{Aceptar}.
% \end{enumerate}
% }
% \end{indicacion}
...
% \item Seleccionar el menú \menu{Gráficas > Gráfica de comparación de cuantiles}.
% \item En el cuadro de diálogo que aparece seleccionar la variable \variable{obs}, activar la opción correspondiente a la distribución normal
% y hacer click en el bo\button{ton{Aceptar}.
% \end{enumerate}
...
% \begin{indicacion}
% \begin{enumerate}
% \item Seleccionar el menú \menu{Estadísticos > Test no paramétricos > Test d\button{lidad de Shapiro-Wilk}.
% \item En el cuadro de diálogo que aparece, seleccionar la variable \variable{obs} en el campo \field{Variable} y hacer click en el botón
% \boton{Aceptar}.
% \end{enumerate}
% }
...
\item En el cuadro de diálogo que aparece, seleccionar la variable \variable{nota} en el campo \field{Variable},
seleccionar la opción \option{Contraste por grupos}, seleccionar la variable {metodologia} en el campo \field{según} y
...
% \item En el cuadro de diálogo que aparece, seleccionar la variable \variable{Nota} en el campo \field{Variable explicada}, la variable
% \variable{Metodología} en el campo \field{Grupos} y hacer click en el botón \boton{Aceptar}.
% \end{enumerate}
% }
% \end{indicacion}
...
\begin{enumerate}\button{
\item Seleccionar el menú \menu{Teaching > Test no paramétricos > Test U de Mann-Whitney para dos muestras independientes}.
\item En el cuadro de diálogo que aparece seleccionar la variable \variable{nota} en el campo \field{Comparar}, la variable
\variable{metodologia} en el campo \field{Según} y hacer click en el botón \boton{Aceptar}.
\end{enumerate}
\end{indicacion}
\end{enumerate}
...
\hline Antes & 147 & 163 & 121 & 205 & \button{90 & 176 & 147 \\
...
\item En el cuadro de diálogo que aparece, introducir la expresión \command{antes-despues}.
\item En el campo \field{Guardar nueva variable} introducir el nombre \variable{diferencia}, hacer click en el botón
...
\begin{enumerate}
\item Seleccionar el menú \menu{Teaching > Test no paramétricos > Normalidad > Test de Shapiro-Wilk}.
\item En el cuadro de diálogo que aparece, seleccionar la variable \variable{diferencia} en el campo \field{Variable} y
hacer click en el botón \boton{Aceptar}.
\end{enumerate}
\end{indicacion}
...
\variable{despues} en el campo \field{Con}.\button{
\item En la solapa \option{Opciones del contraste}, seleccionar la opción \option{Unilateral menor} en el campo \field{Hipótesis
...
variación en la presión \button{l sistólica (antes del tratamiento con el fármaco menos después del tratamiento, en mm
...
\begin{indicacion}\button{
\begin{enumerate}
\item Seleccionar el menú \menu{Teaching > Gráficos > Diagrama de cajas}.
\item En el cuadro de diálogo que aparece, seleccionar la opcion \option{Cajas agrupadas}, seleccionar la variable
\variable{variacion.presion} en el campo \field{Variable}, seleccionar la variable \variable{farmaco} en el campo
\field{Variable de agrupación} y hacer click sobre el botón \boton{Aceptar}.
\end{enumerate}
\end{indicacion}
...
\begin{enumerate}
\item Seleccionar el menú \menu{Teaching > Test no paramétricos > Normalidad > Test de Shapiro-Wilk}.
\item En el cuadro de diálogo que aparece, seleccionar la variable \variable{variacion.presion} en el campo \field{Variable},
seleccionar la opción \option{Contraste por grupos}, seleccionar la variable {farmaco} en el campo \field{según} y
hacer click en el botón \boton{Aceptar}.
\end{enumerate}
\end{indicacion}
...
\item En el cuadro de diálogo que aparece, seleccionar la variable \variable{variacion.presion} en el campo \field{Comparar}, la
variable \variable{farmaco} en el campo \field{Según} y hacer click en el botón \boton{Aceptar}.
\end{enumerate}
\end{indicacion}
...
\begin{enumerate}
\item  Seleccionar el menú \menu{Teaching > Estadísticos > Test no paramétricos > Test de Kruskal-Wallis}.
\item En el cuadro de diálogo que aparece, seleccionar la variable \variable{variacion.presion} en el campo \field{Comparar} y la
variable \variable{farmaco} en el campo \field{Según}.
\item En la solapa \menu{Comparación por pares} seleccionar la opción \option{Comparación por pares} y hacer click en el botón \boton{Aceptar}.
\end{enumerate}
\end{indicacion}
\end{enumerate}
...
puntuación entre 0 y 2, y sumando las cin\button{uaciones se obtiene el resultado del test. El test se realiza al minuto,
...
\begin{enumerate}
\item Seleccionar el menú \menu{Teaching > Test no paramétricos > Normalidad > Test de Shapiro-Wilk}.
\item En el cuadro de diálogo que aparece, seleccionar la variable \variable{apgar1} en el campo \field{Variable} y
hacer click en el botón \boton{Aceptar}.
...
\item En el cuadro de diálogo que aparece, seleccionar las variables \variable{apgar1} y \variable{apgar5} en el campo \field{Variables}.
\item En la solapa \menu{Opciones de correlación}, seleccionar la opción \option{Ro de Spearman} en el campo
\field{Método} y hacer click en el botón \boton{Aceptar}.
\end{enumerate}
\end{indicacion}
\end{enumerate}
