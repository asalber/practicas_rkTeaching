...
\chapter{Regresión no lineal}\label{cap:regresion-no-lineal}
...
\item En el cuadro de diálogo que aparece, seleccionar la variable \variable{bacterias} en el campo \field{Variable Y}
y la variable \variable{horas} en el campo \field{Variable X}, y hacer clic en el botón \button{Enviar}.
\end{enumerate}
\end{indicacion}
...
\item En el cuadro de diálogo que aparece, seleccionar la variable \variable{bacterias} en el campo \field{Variable
dependiente} y la variable \variable{horas} en el campo \field{Variable independiente}.
\item En la solapa de \option{Modelo de regresión} seleccionar el modelo \option{Exponencial}.
\item Seleccionar \option{Guardar modelo} e introducir un nombre para el modelo y hacer clic sobre el botón \button{Enviar}.
\end{enumerate}
Para el modelo cuadrático repetir los pasos pero seleccionando como modelo el \option{Cuadrático}. 
...
\item Seleccionar el menú \menu{Teaching > Gráficos > Diagrama de dispersión}.
\item En el cuadro de diálogo que aparece, seleccionar la variable \variable{bacterias} en el campo \field{Variable Y}
y la variable \variable{horas} en el campo \field{Variable X}.
\item En la solapa \menu{Línea de ajuste} seleccionar la opción \option{Exponencial} y hacer clic sobre el botón \button{Enviar}.
\end{enumerate}
\end{indicacion}
...
\item Introducir los valores $3.5, 10$ en el campo \field{Predicciones para} y hacer clic sobre el botón \button{Enviar}.
...
\begin{enumerate}
\item Seleccionar el menú \menu{Teaching > Regresión > Regresión no lineal}.
\item En el cuadro de diálogo que aparece, seleccionar la variable \variable{horas} en el campo \field{Variable
dependiente} y la variable \variable{bacterias} en el campo \field{Variable independiente}.
\item Seleccionar como modelo el \option{Logarítmico}.
\item Seleccionar \option{Guardar modelo} e introducir un nombre para el modelo y hacer clic sobre el botón \button{Enviar}.
\end{enumerate}
...
\item Introducir el valor $100$ en el campo \field{Predicciones para} y hacer clic sobre el botón \button{Enviar}.
\end{enumerate}
\end{indicacion}
\end{enumerate}
...
\begin{enumerate}
\item Seleccionar el menú \menu{Teaching > Gráficos > Diagrama de dispersión}.
\item En el cuadro de diálogo que aparece, seleccionar la variable \variable{kilos} en el campo \field{Variable Y}, la
variable \variable{dias} en el campo \field{Variable X}, y hacer clic en el botón \button{Enviar}.
\end{enumerate}
\end{indicacion}
...
\item En el cuadro de diálogo que aparece, seleccionar la variable \variable{kilos} en el campo \field{Variable
dependiente} y la variable \variable{dias} en el campo \field{Variable independiente}.
\item En la solapa \menu{Modelos de regresión} seleccionar todos los modelos y hacer clic sobre el botón \button{Enviar}.
...
\begin{enumerate}
\item Seleccionar el menú \menu{Teaching > Gráficos > Diagrama de Dispersión}.
\item En el cuadro de diálogo que aparece, seleccionar la variable \variable{kilos} en el campo \field{Variable Y}
y la variable \variable{dias} en el campo \field{Variable X}.
...
\item En el cuadro de diálogo que aparece, seleccionar la variable \variable{kilos} en el campo \field{Variable
dependiente} y la variable \variable{dias} en el campo \field{Variable independiente}.
\item Seleccionar la opción \option{Filtro} e introducir la condición \lstinline{ejercicio=="no"} en el campo \field{Condición de selección}.
\item En la solapa \menu{Modelos de regresión} seleccionar todos los modelos y hacer clic sobre el botón \button{Enviar}.
\item El mejor modelo aparece en primer lugar y es el que tenga el coeficiente de determinación mayor.
\end{enumerate}
...
\item En el cuadro de diálogo que aparece, seleccionar la variable \variable{kilos} en el campo \field{Variable
dependiente} y la variable \variable{dias} en el campo \field{Variable independiente}.
\item Seleccionar la opción \option{Filtro} e introducir la condición \lstinline{ejercicio=="si"} en el campo \field{Condición de selección}.
\item En la solapa \menu{Modelos de regresión} seleccionar todos los modelos y hacer clic sobre el botón \button{Enviar}.
\item El mejor modelo aparece en primer lugar y es el que tenga el coeficiente de determinación mayor.
\end{enumerate}
Para construir el modelo:
...
\item Introducir los valores $40, 500$ en el campo \field{Predicciones para} y hacer clic sobre el botón \button{Enviar}.
\end{enumerate}
