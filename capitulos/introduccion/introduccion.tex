...
Para cargar un paquete instalado localmente basta son seleccionarlo y hacer clic sobre el botón \button{Cargar}.
...
Para instalar un paquete nuevo basta con seleccionarlo y hacer clic en el botón \button{Aceptar}.
...
\begin{enumerate}
\item Hacer clic en la solapa \button{Espacio de trabajo}.
...
\begin{indicacion}
\begin{enumerate}
\item Hacer clic en la solapa \field{Espacio de trabajo} para desplegarla y ver los paquetes del espacio de trabajo. 
