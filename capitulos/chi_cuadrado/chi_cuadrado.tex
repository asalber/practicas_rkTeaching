...
\field{Frecuencia observada}, seleccionar la variable \variable{probabilidad\_teorica} en el campo \field{Probabilidad
...
\field{Variable dependiente}, seleccionar la variable \variable{grupo.sanguineo} en el campo \field{Variable independiente}, y hacer click en el botón \boton{Aceptar}.
\end{enumerate}
\end{indicacion}
...
\field{Variable dependiente}, seleccionar la variable \variable{region} en el campo \field{Variable independiente}, y hacer click en el botón \boton{Aceptar}.
\end{enumerate}
\end{i\button{on}
...
\begin{enumerate}
\item Seleccionar el menú \texttt{Teaching > Pruebas no paramétricas > Test Chi-cuadrado de independencia}.
\item En el cuadro de diálogo que aparece seleccionar la variable \variable{fuma} en el campo \field{Variable
dependiente}, seleccionar la variable \variable{sexo} en el campo \field{Variable independiente}.
\item En la solapa \menu{Opciones del contraste} seleccionar \option{Test exacto de Fisher}, y hacer click en el
botón \boton{Aceptar}.
\end{enumerate}
\end{indicacion}
...
\begin{enumerate}
\item Seleccionar el menú \texttt{Teaching > Pruebas no paramétricas > Test Chi-cuadrado de independencia}.
\item En el cuadro de diálogo que aparece seleccionar la variable \variable{mejora.farmaco1} en el campo \field{Variable
dependiente}, seleccionar la variable \variable{mejora.farmaco2} en el campo \field{Variable independiente}.
\item En la solapa \menu{Opciones del contraste} seleccionar \option{Test de McNemar para datos pareados}, y hacer click en el
botón \boton{Aceptar}.
\end{enumerate}
\end{indicacion}
