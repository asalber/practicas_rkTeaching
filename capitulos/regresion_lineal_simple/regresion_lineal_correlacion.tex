\chapter{Regresión Lineal Simple y Correlación}\label{cap:regresion-lineal}
...
\item En el cuadro de diálogo que aparece, seleccionar la variable \variable{Y} en el campo \field{Variable Y}, la
variable \variable{X} en el campo \field{Variable X}, y hacer clic en el botón \button{Enviar}.
\end{enumerate}
\end{indicacion}
...
\item En el cuadro de diálogo que aparece, seleccionar la variable \variable{Y} en el campo \field{Variable
dependiente} y la variable \variable{X} en el campo \field{Variable independiente}, y hacer clic sobre el botón
\button{Enviar}.
\end{enumerate}
\end{indicacion}
...
\item En el cuadro de diálogo que aparece, seleccionar la variable \variable{Y} en el campo \field{Variable Y}, la
variable \variable{X} en el campo \field{Variable X}, y hacer clic en el botón \button{Enviar}.
\item En la solapa \menu{Línea de ajuste}, seleccionar \option{Dibujar recta de regresión} y hacer clic en el botón
\button{Enviar}.
\end{enumerate}
\end{indicacion}
...
\begin{indicacion}
Repetir los pasos de los apartados anteriores pero escogiendo como \field{Variable dependiente} la variable \variable{X},
y como \field{Variable independiente} la variable \variable{Y}
\end{indicacion}
...
\item En el cuadro de diálogo que aparece, seleccionar la variable \variable{horas.estudio} en el campo \field{Variable
a tabular en filas}, la variable \variable{suspensos} en el campo \field{Variable a tabular en columnas}, y hacer clic
sobre el botón \button{Enviar}. 
\end{enumerate}
\end{indicacion}
...
\begin{enumerate}
\item Seleccionar el menú \menu{Teaching > Regresión > Regresión lineal}.
\item En el cuadro de diálogo que aparece, seleccionar la variable \variable{suspensos} en el campo \field{Variable
dependiente} y la variable \variable{horas.estudio} en el campo \field{Variable independiente}, seleccionar
\option{Guardar el modelo}, introducir un nombre para el modelo y hacer clic sobre el botón \button{Enviar}.
\end{enumerate}
Para dibujar la recta de regresión:
\begin{enumerate}
\item Seleccionar el menú \menu{Teaching > Gráficos > Diagrama de Dispersión}.
\item En el cuadro de diálogo que aparece, seleccionar la variable \variable{suspensos} en el campo \field{Variable Y} y
la variable \variable{horas.estudio} en el campo \field{Variable X}.
\item En la solapa \menu{Línea de ajuste}, seleccionar \option{Lineal} y hacer clic en el botón
\button{Enviar}.
\end{enumerate}
\end{indicacion}
...
\begin{indicacion}
El coeficiente de determinación aparece en la ventana de resultados como \result{R$^2$}, y el
...
apartado, introducir los valores para los que se desea la predicción en el campo \field{Predicciones para} y hacer clic
sobre el botón \button{Enviar}.
\end{enumerate}
\end{indicacion}
...
\begin{enumerate}
\item Seleccionar el menú \menu{Teaching > Regresión > Regresión lineal}.
\item En el cuadro de diálogo que aparece, seleccionar la variable \variable{alcohol} en el campo \field{Variable
dependiente} y la variable \variable{tiempo} en el campo \field{Variable independiente}, y hacer clic sobre el botón
\button{Enviar}.
\end{enumerate}
\end{indicacion}
...
\begin{enumerate}
\item Seleccionar el menú \menu{Teaching > Gráficos > Diagrama de Dispersión}.
\item En el cuadro de diálogo que aparece, seleccionar la variable \variable{alcohol} en el campo \field{Variable Y} y
la variable \variable{tiempo} en el campo \field{Variable X}.
\item En la solapa \menu{Línea de ajuste}, seleccionar \option{Lineal} y hacer clic en el botón \button{Enviar}.
\end{enumerate}
...
al dato con el residuo atípico y seleccionar \option{Borrar esta fila}.
\end{indicacion}
...
\begin{enumerate}
\item Seleccionar el menú \menu{Teaching > Regresión > Regresión lineal}.
\item En el cuadro de diálogo que aparece, seleccionar la variable \variable{tiempo} en el campo \field{Variable
dependiente} y la variable \variable{alcohol} en el campo \field{Variable independiente}.
\item Seleccionar \option{Guardar el modelo}, introducir un nombre para el modelo y hacer clic sobre el botón \button{Enviar}.
\end{enumerate}
Para hacer la predicción:
\begin{enumerate}
\item Seleccionar el menú \menu{Teaching > Regresión > Predicciones}.
\item En el cuadro de diálogo que aparece seleccionar como modelo de regresión la recta calculada e introducir los
valores para los que se desea la predicción en el campo \field{Predicciones para} y hacer clic sobre el botón
\button{Enviar}.
\end{enumerate}
\end{indicacion}
\end{enumerate}
...
\begin{enumerate}
\item Seleccionar el menú \menu{Teaching > Regresión > Regresión lineal}.
\item En el cuadro de diálogo que aparece, seleccionar la variable \variable{estatura} en el campo \field{Variable
dependiente} y la variable \variable{edad} en el campo \field{Variable independiente}, y hacer clic en el botón
\button{Enviar}.
\end{enumerate}
\end{indicacion}
...
\begin{enumerate}
\item Seleccionar el menú \menu{Teaching > Gráficos > Diagrama de Dispersión}.
\item En el cuadro de diálogo que aparece, seleccionar la variable \variable{estatura} en el campo \field{Variable Y},
la variable \variable{edad} en el campo \field{Variable X}, y hacer clic en el botón \button{Enviar}.
\end{enumerate}
\end{indicacion}
...
\item En el cuadro de diálogo que aparece seleccionar en el campo \field{Variable a recodificar} la variable
\variable{edad}.
...
\item En el cuadro de diálogo que aparece seleccionar como objeto padre la el conjunto de datos \variable{edad\_estatura} y hacer clic sobre el botón \button{Aceptar}.
\item Introducir el nombre de la nueva variable \variable{grupo.edad} y hacer clic sobre el botón \button{Enviar}.
\end{enumerate}
\end{indicacion}
...
\item Seleccionar el menú \menu{Teaching > Regresión > Regresión lineal}.
\item En el cuadro de diálogo que aparece, seleccionar la variable \variable{estatura} en el campo \field{Variable
dependiente} y la variable \variable{edad} como \field{Variable independiente}.
\item Seleccionar la opición \option{Ajuste por grupos}, introducir la variable \variable{grupo.edad} en el campo
\field{Variable de agrupación}, y hacer clic en el \button{Enviar}.
\end{enumerate}
\end{indicacion}
...
\begin{enumerate}
\item Seleccionar el menú \menu{Teaching > Gráficos > Diagrama de Dispersión}.
\item En el cuadro de diálogo que aparece, seleccionar la variable \variable{estatura} en el campo \field{Variable Y} y
la variable \variable{edad} en el campo \field{Variable X}.
\item Seleccionar la opción \option{Dibujar por grupos} e introducir la variable \variable{grupo.edad} en el campo
\field{Variable de agrupación}.
\item En la solapa \menu{Línea de ajuste}, seleccionar \option{Lineal} y hacer clic en el botón
\button{Enviar}.
\end{enumerate}
\end{indicacion}
...
introducir 14 en el campo \field{Predicciones para} y hacer clic sobre el botón
\button{Enviar}.
\end{enumerate}
para predecir la estatura de la persona de 38 años, repetir lo mismo pero seleccionando la recta de regresión para los
mayores e introducidento 38 en el campo \field{Predicciones para}.
\end{indicacion}
\end{enumerate}
...
% Se pide:
% \begin{enumerate}
% \item Crear un conjunto de datos con las variables \variable{X} e \variable{Y} e introducir los datos.
...
% \field{Variables}.
% \item En la solapa \menu{Opciones de correlación} seleccionar el método de \option{Ro de Spearman} y hacer clic sobre
