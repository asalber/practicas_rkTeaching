...
pdftitle = {Bioestadística Aplicada con R y rkTeaching},
pdfsubject = {Bioestadística},
pdfkeywords = {Estadística, Bioestadística, R},
...
\input{preambulo/commands_book} % Insert the commands_book.tex file which contains the majority of the structure behind
% the template
...
\include{capitulos/distribuciones_graficas/distribuciones_graficas}
\include{capitulos/estadisticos/estadisticos}
\include{capitulos/regresion_lineal_simple/regresion_lineal_correlacion}
\include{capitulos/regresion_no_lineal/regresion_no_lineal}
\include{capitulos/probabilidad/probabilidad}
\include{capitulos/variables_aleatorias_discretas/variables_aleatorias_discretas}
\include{capitulos/variables_aleatorias_continuas/variables_aleatorias_continuas}
\include{capitulos/intervalos_confianza_1_muestra/intervalos_confianza_1_muestra}
\include{capitulos/intervalos_confianza_2_muestras/intervalos_confianza_2_muestras}
% \include{capitulos/contrastes/contrastes}
% \include{capitulos/anova_1_factor/anova_1_factor}
% % \include{capitulos/anova_2_factores/anova_2_factores}
% \include{capitulos/contrastes_no_parametricos/contrastes_no_parametricos}
% \include{capitulos/chi_cuadrado/chi_cuadrado}
% \include{capitulos/concordancia/concordancia}
% \appendix
% \include{capitulos/comandos_R} 
\end{document}
