...
\item En el cuadro de diálogo que aparece, seleccionar la variable \variable{hijos} en el campo \campo{Variable a
tabular} y hacer clic en el botón \boton{Enviar}.
\end{enumerate}}
\end{indicacion}
...
\item En el cuadro de diálogo que aparece, seleccionar la variable \variable{hijos} en el campo \campo{Variable} y hacer
...
\item En el cuadro de diálogo que aparece, seleccionar la variable \variable{urgencias} en el campo \campo{Variables} y
...
\item En la solapa de \opcion{Clases} activar la casilla \opcion{Agrupar en intervalos}, marcar la opción \opcion{Número
de intervalos} e introducir el número deseado de intervalos en el campo \campo{Intervalos sugeridos} y hacer clic sobre el botón
\boton{Enviar}.
\end{enumerate}}
\end{indicacion}
...
\item En el cuadro de diálogo que aparece seleccionar la variable \variable{urgencias} en el campo \campo{Variable}.
\item En la solapa de \opcion{Clases} activar la casilla \opcion{Agrupar en intervalos}, marcar la opción \opcion{Número
de intervalos} e introducir el número deseado de intervalos en el campo \campo{Intervalos sugeridos} y hacer clic sobre el botón
\boton{Enviar}.
\end{enumerate}}
...
\campo{Variable a tabular} y hacer clic en el botón \boton{Enviar}.
\end{enumerate}}
\end{indicacion}
...
\item En el cuadro de diálogo que aparece, seleccionar la variable \variable{grupo.sanguineo} en el campo
\campo{Variables} y hacer clic sobre el botón \boton{Enviar}.
\end{enumerate}}
\end{indicacion}
\end{enumerate}
...
\begin{enumerate}
\item Seleccionar el menú \menu{Teaching>Distribución de frecuencias>Tabla de frecuencias}.
\item En el cuadro de diálogo que aparece, seleccionar la variable \variable{edad} en el campo \campo{Variable a
tabular}, activar la casilla \opcion{Tabular por grupos}, seleccionar la variable \variable{estado.civil} en el campo
\campo{Variable de agrupación} y hacer clic en el botón \boton{Enviar}.
\end{enumerate}}
\end{indicacion}
...
\begin{enumerate}
\item Seleccionar el menú \menu{Teaching>Gráficos>Diagrama de cajas}.
\item En el cuadro de diálogo que aparece, seleccionar la variable \variable{edad} en el campo \campo{Variables},
activar la casilla \opcion{Dibujar por grupos}, seleccionar la variable \variable{estado.civil} en el campo
\campo{Variable de agrupación} y hacer clic en el botón \boton{Enviar}.
\end{enumerate}}
\end{indicacion}
\end{enumerate}
