...
\item En el cuadro de diálogo que aparece, cambiar el valor de \opcion{n} hasta 30 y el de \opcion{p} hasta 0.1.
\item Después cambiar el valor de \opcion{n} hasta 100 y el de \opcion{p} hasta 0.03.
\end{enumerate}}
\end{indicacion}
\end{enumerate}
\end{enumerate}
