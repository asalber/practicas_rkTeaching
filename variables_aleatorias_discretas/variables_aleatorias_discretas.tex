...
\begin{indicacion}
\begin{enumerate}
\item Seleccionar el menú \menu{teaching > Distribuciones > Discretas > Binomial > Probabili\-dades}.
...
\begin{indicacion}
\begin{enumerate}
\item Seleccionar el menú \menu{Teaching > Distribuciones > Discretas > Binomial > Gráfico de probabilidad}.
...
\begin{indicacion}
\begin{enumerate}
\item Seleccionar el menú \menu{Teaching > Distribuciones > Discretas > Poisson > Gráfico de probabilidad}.
...
\begin{indicacion}
\begin{enumerate}
\item Seleccionar el menú \menu{Teaching > Distribuciones > Discretas > Poisson > Probabili\-dades}.
